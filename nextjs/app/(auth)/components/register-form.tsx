    ...
    <>
      ...
      <Dialog open={isOpen}>
        <DialogContent>
          ...
          <div>
            <p className='py-2'>
              Xin chào <span className='font-semibold'>{name}</span>, chúng tôi đã gửi một email xác nhận đến{' '}
              <span className='font-semibold'>{email}</span>. Vui lòng kiểm tra email của bạn để hoàn tất quá trình đăng
              ký, {''}
              <Link className='font-semibold text-blue-600 hover:text-blue-500' href='/verify-email'>
