...
import { FaComments, FaConnectdevelop, FaHome, FaShopify, FaUser, FaUserShield } from 'react-icons/fa'
          ...
          {menu.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
              >
                <Icon size={20} className='size-5' /> <span className='hidden group-hover:block'>{item.label}</span>
              </Link>
            )
          })}
          <Separator />
