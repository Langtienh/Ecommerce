...
export default function VerifyEmailForm({ email, verifyEmailToken }: VerifyEmailFormProps) {
  ...
  console.log('VerifyEmailFormProps', { email, verifyEmailToken })
  return (
    <Dialog open={true}>
      <DialogContent className='sm:max-w-[425px] p-0 overflow-hidden'>
        ...
        <div className='p-5 pb-20 w-full'>
          ...
          <div className='flex justify-center py-5 w-full'>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit, handlerError)} className=' space-y-6 w-full'>
                <FormField
                ...
                <Button disabled={isLoading} size='lg' variant='destructive' type='submit' className='w-full'>
                  Xác nhận
                </Button>
              </form>
            </Form>
          ...
          <div className='flex items-center justify-center gap-5'>
            <Button className='border-blue-600 text-blue-500' size='lg' variant='outline' onClick={handleBack}>
              Quay lại
            </Button>
            <Button className='border-blue-600 text-blue-500' size='lg' variant='outline' onClick={handleResend}>
              Gửi lại OTP
            </Button>
          </div>
